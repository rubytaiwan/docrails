...
TIP: 注意在 Ruby 1.8.7 p248 和 p249 的 Marshal 函式庫有臭蟲，會造成 Rails 意外結束。 Ruby Enterprise Edition 已經在版號 1.8.7-2010.02 修正了這個錯誤。而在 Ruby 1.9 的部份，由於 Ruby 1.9.1 本身就會出現徹底地 segmentation fault ，因而無法使用。想要用 Ruby 1.9 的使用者，請直接安裝 1.9.2 就可以順利的運行。
